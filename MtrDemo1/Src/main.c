...
static void MX_ADC1_Init(void)
{
  ...
  */
  LL_ADC_INJ_ConfigQueueContext(ADC1, LL_ADC_INJ_TRIG_EXT_TIM1_TRGO, LL_ADC_INJ_TRIG_EXT_RISING, LL_ADC_INJ_SEQ_SCAN_ENABLE_3RANKS, 0x0000, 0x0000, 0x0000, 0x0000);
...
static void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(GPIOC, M1_PWM_EN_U_Pin|M1_PWM_EN_V_Pin|M1_PWM_EN_W_Pin);
