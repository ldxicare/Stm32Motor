...
#define RS                     0.81 /* Stator resistance , ohm*/
#define LS                     0.000814 /* Stator inductance, H
...
#define NOMINAL_CURRENT         17145
#define MOTOR_MAX_SPEED_RPM     1632 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  10.2 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -17145 /*!< Demagnetization current */
...
/*** Quadrature encoder ***/
#define M1_ENCODER_PPR             2500  /*!< Number of pulses per
                                            revolution */
